...
<div style="text-align: center">
	<img src="{{ 'assets/images/bar_daemon_in_action.png' | absolute_url }}" width="80%" title="bar_daemon in action"/>
</div>
...
<ul>
	...
	<li>Sends desktop notifications via <code>dunstify</code> when resources change.</li>
...
<ul>
	...
	<li>Pushes full state as <strong>JSON</strong> to all connected listeners, triggered when any resource changes.</li>
	  ...
	  <table>
			...
			<tbody>
				<tr>
					...
					<td>
						<ul>
							...
							<li>Outputs errors and logs to a file.</li>
						</ul>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<ul>
							<li>Gets the value of the <code>RESOURCE</code>'s <code>VALUE_TYPE</code>.</li>
							<li>Gets all values for the <code>RESOURCE</code> if no <code>VALUE_TYPE</code> is supplied.</li>
							<li>If no <code>RESOURCE</code> is provided, gets <strong>all</strong> values for <strong>all</strong> resources.</li>
						</ul>
					</td>
				</tr>
				<tr>
					...
					<td>
						<ul>
							<li>Sets the value of the requested <code>RESOURCE</code>'s <code>VALUE_TYPE</code>.</li>
