...
export interface InitOutput {
  ...
  readonly closure10110_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9098287f32d3a58c: (a: number, b: number) => void;
  readonly closure10115_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure10396_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h61cb77d962dc6eff: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he5b7a46fa86ee166: (a: number, b: number) => void;
  readonly closure62181_externref_shim: (a: number, b: number, c: any) => void;
